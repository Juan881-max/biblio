...
export default function Home({ books, onAddBook, user }: HomeProps) {
    ...
    <div className="min-h-screen pb-20">
      ...
      <section className="relative h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-4">
          ...
          >
            <button
              onClick={() => user ? setIsModalOpen(true) : alert('Inicia sesión para añadir reseñas')}
      ...
      <main className="max-w-7xl mx-auto px-4 mt-16">
        ...
        {books.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200">
            ...
            <p className="text-slate-500 font-serif text-xl">Aún no hay libros en la biblioteca.</p>
            {user ? (
              <button
              ...
              <p className="mt-4 text-slate-400 flex items-center justify-center gap-2">
                <Lock size={16} />
                Inicia sesión para añadir reseñas
              </p>
            )}
          </div>
        ) : (
